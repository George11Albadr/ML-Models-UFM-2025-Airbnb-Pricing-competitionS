...
# airbnb_price_determinant documentation build
...
from airbnb_price_determinant import __version__ as release

# -- Project information -----------------------------------------------------

project = "airbnb_price_determinant"
author = "Kedro"
...
htmlhelp_basename = "airbnb_price_determinantdoc"
...
latex_documents = [
    (
        master_doc,
        "airbnb_price_determinant.tex",
        "airbnb_price_determinant Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "airbnb_price_determinant",
        "Project airbnb_price_determinant codebase.",
        "Data-Science",
    )
]
